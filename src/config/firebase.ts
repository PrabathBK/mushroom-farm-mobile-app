...
// @ts-ignore - getReactNativePersistence exists in the React Native build of firebase/auth
// Metro bundler resolves firebase/auth to dist/rn/index.js which exports this function
